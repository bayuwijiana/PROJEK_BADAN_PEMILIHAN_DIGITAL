            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="{{ route('penduduk.index') }}">
                        <i class="zmdi zmdi-grid"></i> <span>DATA PENDUDUK</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="/logout">
                        <i class="zmdi zmdi-calendar-check"></i> <span>lOGOUT</span>
                    </a>
                </li>
                ...
                <li><a href="fromemail2"><i class="zmdi zmdi-coffee text-danger"></i>
