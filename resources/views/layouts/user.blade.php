...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">BizLand IT<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#REKRUTMEN">REQRUTMEN</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Welcome to <span>in BizLand iT</span></h1>
        <h1>HELLOW USER !!</h1>       
      <div class="d-flex">
        <a href="#REKRUTMEN" class="btn-get-started scrollto">Get Started</a>
    ...
    <section id="ABOUT" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Industie Bizland</h2>
          <h3>Check our <span>Industrie</span></h3>
          <h2>Bizland INdustrie .IT</h2>
          <p>
            Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque vitae autem.</p>
        </div>
